...
export const products: Product[] = [
  {
    ...
    galleryImages: [
      "/images/dk-105-2.avif",
      "/images/dk105-parts.avif",
      "/images/dk105-3.jpg",
      "/images/dk105-4.jpg",
      "/images/dk105-5.jpg",
      "/images/dk105-6.jpg",
    ...
    bulletFeatures: [
      ...
      'Adapts to 1¼" bathroom and 1½" kitchen sink*',
  ...
  },
  {
    ...
    bulletFeatures: [
      ...
      "Easy to install - No tools required",
      "Adjustable for any space",
      "Also ideal for bar and laundry sinks",
      "Code Approved",
      "Secure connections every time",
      "NO residue build-up",
      "NO odor problem",
  ...
  },
  {
    ...
    bulletFeatures: [
      ...
      "Easy to install - No tools required",
      "Adjustable for any space",
      "Ideal for double bowl kitchen sink with or without waste disposal",
      "Code Approved",
      "Secure connections every time",
      "NO residue build-up",
      "NO odor problem",
