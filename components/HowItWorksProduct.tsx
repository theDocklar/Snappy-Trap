          ...
          <div className="space-y-6 text-white">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="font-medium text-lg text-white">Universal fit with quick, one-step install</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-white mt-1">•</span>
                <p className="font-medium text-lg text-white">Tool-free DIY setup, no cutting or measuring</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-white mt-1">•</span>
                <p className="font-medium text-lg text-white">Compact, flexible design saves under-sink space</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-white mt-1">•</span>
                <p className="font-medium text-lg text-white">Smooth hose prevents clogs, odors & buildup</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-white mt-1">•</span>
                <p className="font-medium text-lg text-white">Premium seals ensure durable, leak-free joints</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-white mt-1">•</span>
                <p className="font-medium text-lg text-white">30-day money back guarantee</p>
              </div>
            </div>
            ...
            <div className="pt-6 space-y-4">
              ...
              <div className="flex gap-4">
                {[1, 2, 3, 4, 5].map((item) => (
                  <div key={item} className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="font-medium text-sm text-white text-center">FREE SHIPPING</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                    {/* Truck icon placeholder */}
                  </div>
                  <p className="font-medium text-sm text-white text-center">FAST DELIVERY</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                    {/* Truck icon placeholder */}
                  </div>
                  <p className="font-medium text-sm text-white text-center">EASY RETURNS</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                    {/* Truck icon placeholder */}
                  </div>
                  <p className="font-medium text-sm text-white text-center">SECURE PAYMENT</p>
                </div>
              </div>
            </div>
          </div>
