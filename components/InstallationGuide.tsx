...
const benefits = [
  {
    ...
    description:
      "Installation requires no special tools or plumbing experience. Everything you need is included in the kit.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "The flexible pipe adapts to any space configuration, handling offset connections with ease.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Our patented connection system ensures a secure, leak-free seal that lasts for years.",
  },
  {
    icon: (
      <svg
      ...
      >
        ...
        />
        <path
          d="M8 32C8 36.4183 11.5817 40 16 40H32C36.4183 40 40 36.4183 40 32V24"
          stroke="white"
          strokeWidth="4"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    description:
      "Complete installation in under 15 minutes. No waiting for plumbers or scheduling appointments.",
  },
];
