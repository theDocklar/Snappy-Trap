      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12 mb-10 sm:mb-12 lg:mb-16">
          ...
          <div className="lg:col-span-2">
            <h2 className="font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white tracking-[-1.2px] uppercase mb-5 sm:mb-6 lg:mb-8 leading-tight">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="relative mb-2 sm:mb-3">
                      <span className="text-4xl sm:text-5xl lg:text-6xl text-[#BEDBFF] font-light leading-none absolute -left-1 sm:-left-2 -top-1 sm:-top-2">
                        "
                      </span>
                      <p className="font-bold text-sm sm:text-base lg:text-lg text-black pl-4 sm:pl-5 lg:pl-6">
                        {testimonial.quote}
                      </p>
                    </div>
