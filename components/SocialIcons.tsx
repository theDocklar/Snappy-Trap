...
export default function SocialIcons({
  ...
  const isInstagramAndNegative =
    platform === "Instagram" && color === "Negative";
  const isLinkedInAndNegative = platform === "LinkedIn" && color === "Negative";
  const isYouTubeAndNegative = platform === "YouTube" && color === "Negative";
  const isTikTokAndNegative = platform === "TikTok" && color === "Negative";

  return (
    <div className={`relative ${className}`}>
      {isFacebookAndNegative && (
        <svg
          role="img"
          viewBox="0 0 24 24"
