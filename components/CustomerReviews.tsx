const reviews = [
  ...
  {
    quote: "Perfect fit for my kitchen sink. The flexible design made installation so easy!",
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="relative mb-3">
                    <span className="text-5xl text-[#BEDBFF] font-light leading-none absolute -left-2 -top-2">"</span>
        ...
        <div className="text-center">
          <a href="#" className="font-medium text-lg text-black hover:underline">
            view more
          </a>
        </div>
      </div>
