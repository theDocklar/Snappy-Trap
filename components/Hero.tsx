              ...
              */}
              <div
                ...
                style={{
                  ...
                  transition: isAnimating ? "transform 0.75s ease-in-out" : "none",
                }}
          ...
          <div className="order-2 lg:order-2 space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 max-w-xl">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 rounded-xl sm:rounded-2xl px-4 sm:px-5 py-3 sm:py-4 ">
                ...
                <span className="font-bold text-sm sm:text-base text-white tracking-[0.35px] uppercase">kitchen & bath</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start sm:items-center justify-center lg:justify-start gap-4 sm:gap-8 lg:gap-14 text-blue-100">
              <div className="flex items-center justify-center lg:justify-start space-x-2">
                <svg width="122" height="16" viewBox="0 0 122 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-3 sm:h-4">
                ...
                <span className="font-bold text-lg sm:text-xl lg:text-2xl text-center lg:text-left">Reviews</span>
              </div>
              <div className="flex items-center justify-center lg:justify-start space-x-3 sm:space-x-4 lg:space-x-6">
                <svg width="48" height="42" viewBox="0 0 48 42" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-8 sm:w-12 sm:h-9 lg:w-14 lg:h-10">
                ...
                <span className="font-bold text-base sm:text-lg lg:text-xl text-center lg:text-left">5 year Limited warranty</span>
              </div>
            </div>

            {/* Social Media Icons */}
            <div className="flex items-center justify-center lg:justify-start space-x-8 mt-8">
              <a href="https://youtube.com/@snappytrap" target="_blank" rel="noopener noreferrer" className="w-10 h-10 hover:opacity-70 transition-opacity" aria-label="YouTube">
                <SocialIcons platform="YouTube" color="Negative" />
              </a>
              <a href="https://instagram.com/snappytrap" target="_blank" rel="noopener noreferrer" className="w-9 h-9 hover:opacity-70 transition-opacity" aria-label="Instagram">
                <SocialIcons platform="Instagram" color="Negative" />
              </a>
              <a href="https://facebook.com/snappytrap" target="_blank" rel="noopener noreferrer" className="w-9 h-9 hover:opacity-70 transition-opacity" aria-label="Facebook">
                <SocialIcons platform="Facebook" color="Negative" />
              </a>
              <a href="https://tiktok.com/@snappytrap" target="_blank" rel="noopener noreferrer" className="w-9 h-9 hover:opacity-70 transition-opacity" aria-label="TikTok">
